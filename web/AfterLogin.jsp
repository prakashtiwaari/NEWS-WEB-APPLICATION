<%-- 
    Document   : AfterLogin
    Created on : 5 Apr, 2019, 7:07:19 PM
    Author     : Dell
--%>
        ...
        <div class="top-header-area">
            ...
            // out.println("HELLO "+a); %>
             ...
             &nbsp;&nbsp;
                                  ...
                                  <%  out.print("<a href='ReportNews.jsp?p1="+a+"'>Report News</a>"); %>
                                     <a href="Posts.jsp">Analytics</a>
                                </div>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="newspaperNav">
                        ...
                        <div class="classy-menu" style="float:left;">
...
<hr>
<hr>
<h1 style="text-align:center">TOP 3 NEWS REPORTER OF MNNIT</h1>
<hr>
<hr>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-add">
                        <a href="#"><img src="img/core-img/mnnit.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <div class="footer-widget-area mt-80">
                            ...
                            <!-- List -->
                            <ul class="list">
                                <li><a href="mailto:mnnitNews@gmail.com">mnnitNews@gmail.com</a></li>
                                <li><a href="Mob:+9999999999">+91 9999999999</a></li>
                                <li><a href="http://yoursitename.com">www.mnnitnewspaper.com</a></li>
                            </ul>
                        </div>
                    </div>
...
<h6 style="color:white">Copyright &copy;<script>document.write(new Date().getFullYear());</script> </h6><h5 style="color:white">All rights reserved | MNNIT NEWSPAPER&nbsp;<i class="fa fa-heart-o" aria-hidden="true"></i> </h5> 
                    </div>
                </div>
            </div>
        </div>
